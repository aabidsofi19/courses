...
class Heap :
    ...
    def __init__(self,arr) -> None:
        ...
        self.map : Dict[Hashable,int] = {} #stores the mapping of keys to array index 
    ...
    def swap(self,i,j) :
        ...
        self.map[self.heap[i]] , self.map[self.heap[j]]  = j , i
    ...
    def insert(self,key,value) :
        item = PriortisedItem(value,key)
        self.heap.append(item)
        self.map[item] = self.size 
...
if __name__ == "__main__":
    l = [10 , 4,4,11,13,12,9,8]
    h = MaxHeap(l)
    l = Heap(l)
    print(l.heap)
    print("deleted" , l.delete(8)) 
